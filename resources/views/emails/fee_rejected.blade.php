...
<head>
    <meta charset="UTF-8">
    <title>Fee Rejected - Rudra ACK Solutions</title>
    <style>
        .mailicon a {
                                ...
                                <tr>
                                    <td style="padding:25px 60px">
                                        <div style="border-bottom:2px dotted #16345c;color:#16345c;padding-bottom:1em;">
                                            ...
                                            <p>⚠️ Unfortunately, your recent fee payment has been <strong style="color:red">REJECTED</strong>.</p>
                                        </div>

                                        <div style="color:#444;margin-top:15px;">
                                            <p>
                                                📌 <strong>Transaction ID:</strong> {{ $ledger->provided_transaction_id }} <br>
                                                📌 <strong>Amount Entered:</strong> ₹{{ $ledger->fee_received }}
                                            </p>

                                            <p>We’re unable to process your payment at this time. Please contact our support team for clarification or re-submit your payment at the earliest.</p>
